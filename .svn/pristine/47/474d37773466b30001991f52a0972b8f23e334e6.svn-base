...
public class DistributorManageService {
    ...
    public GridResult queryDistributorListForPage(HttpServletRequest request) {
        ...
        try {
            ...
            if (list != null && list.size() > 0) {
                 ...
                 Map<String, Object> resPr=(Map<String, Object>)this.queryForPost(smsMap,retail_service_new_url+"open/ManageRole/getAgentRole");
    ...
    public ProcessResult editDistributionState(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            if (this.distributorManageDao.updateDistributionStateById(params) > 0) {
                ...
                Map<String, Object> resPr = (Map<String, Object>) this.queryForPost(sendMap, retail_service_new_url+"open/ManageRole/initAgentRelate");
                if (Integer.parseInt(resPr.get("state").toString()) == 1) {
                    pr.setState(true);
    ...
    public GridResult queryRevenueListForDistribution(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            if(params.containsKey("TRADE_STATE") && !StringUtils.isEmpty(params.get("TRADE_STATE"))){
                sendMap.put("TRADE_STATE",params.get("TRADE_STATE"));
            }
            Map<String, Object> resPr = (Map<String, Object>) this.queryForPost(sendMap, retail_service_new_url+"open/Agent/agentTrade");
            if (Integer.parseInt(resPr.get("state").toString()) == 1) {
                gr.setState(true);
    ...
    public GridResult queryDistributionInfo(HttpServletRequest request) {
        ...
        try {
            ...
            Map<String, Object> resPr = (Map<String, Object>) this.queryForPost(sendMap, retail_service_new_url+"open/Order/findOrderWhereList");
            if (Integer.parseInt(resPr.get("state").toString()) == 1) {
            	gr.setObj(resPr);
