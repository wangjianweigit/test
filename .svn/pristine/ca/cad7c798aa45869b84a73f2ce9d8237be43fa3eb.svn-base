...
public interface MemberInfoDao {
     ...
     * @return
     */
    public int queryMemberInfoRecordByLoginName(String login_name);
    /**
     * 根据登录用户名查找用户
     * @param login_name
     * @return
	 ...
	 * @return
	 */
	public int countMemberInfoApplyByLoginName(Map<String,Object> params);
    /**
     * 根据电话查找用户查找用户
     * @param login_name
     * @return
     */
    public int queryMemberInfoRecordByMobilePhone(Map<String,Object> params);
	/**
	 * 根据身份证号查找用户数量(临时表)
	 * @param params
	 * @return
	 */
	public int queryMemberInfoRecordByUserManageCardId(Map<String,Object> params);
	/**
	 * 根据身份证号查找用户数量(主表)
	 * @param params
	 * @return
     ...
     */
      ...
      * @return
      */
     public int insertMemberInfoRecord(Map<String,Object> params);
     /**
      * 新增平台会员申请成为经销商申请记录
      * @param login_name
      * @return
...
// 	public int updateMemberStateToPause(Map<String, Object> params);
     ...
     * @return
     */
    public Map<String, Object> queryMemberInfoRecordById(Map<String,Object> params);
    /**
     * 更新会员申请信息
     * @param params
     * @return
...
//    public int updateMemberInfoApply(Map<String,Object> params);
     ...
     * @return
     */
    public int updateMemberInfoRecordState(Map<String,Object> params);
    /**
     * 更新会员信息
     * @param params
     * @return
	 ...
	 * @return
	 */
	public int countUserAddress(@Param("user_id")long user_id);
    /**
     * 新增用户地址
     * @param login_name
     * @return
     ...
     * @return
     */
    public Map<String,Object> queryMemberDetailByUserName(Map<String,Object> params);
    /**
     * 根据用户名启用或禁用用户
     * @param params
     * @return
...
//	MemberInfo queryUserInfoPreChkInfo(@Param("userName") String userName);
	 ...
	 * @return
	 */
	int insertMemberInfoRecordFromOldData(Map<String, Object> params);
	 ...
	 * @return
	 */
	List<Map<String, Object>> queryChangeLogListByUserId(Map<String, Object> params);
	 ...
	 * @return
	 */
	int queryChangeLogCountByUserId(Map<String, Object> params);
	 ...
	 * @return
	 */
	Map<String, Object> queryChangeLogDetailById(Map<String, Object> params);
	 ...
	 * @return
	 */
	int insertMemberInfoRecordByUser(Map<String, Object> params);
	 /**
     * 通过用户表信息新增用户地址
     * @param login_name
     * @return
     */
    public int insertUserAddressByUserId(@Param("user_id")long user_id);
	 ...
	 * @return
	 */
	int updateMemberInfoPendingRecord(Map<String, Object> params);
}
