...
public interface ReturnsDao {
	 ...
	 * @return
	 */
	List<Long> queryReturnProductSkuAutoShelf(@Param("returnNumber") String returnNumber);
	 ...
	 * @return
	 */
	int updateReturnProductSkuAutoShelf(List<Long> list);
	 ...
	 * @return
	 */
	int updateReturnProductInfoAutoShelf(List<Long> list);
}