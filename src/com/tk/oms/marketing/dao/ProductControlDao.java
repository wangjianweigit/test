...
public interface ProductControlDao extends BaseDao<Map<String, Object>>{
	 ...
	 * @return
	 */
	public List<Map<String, Object>> queryProductControlDetailListById(long id);
	/**
	 * 控货详情品牌列表
	 * @param paramMap
	 * @return
	 */
	public List<Map<String, Object>> queryProductControlDetailList(Map<String, Object> paramMap);
	/**
	 * 查询控货申请ID
	 * @param paramMap
	 * @return
	 ...
	 * @return
	 */
	public int queryProductControlSettingCount(Map<String, Object> paramMap);
	/**
	 * 查询控货设置列表
	 * @param paramMap
	 * @return
	 */
	public List<Map<String, Object>> queryProductControlSettingList(Map<String, Object> paramMap);
	/**
	 * 达成率明细总数
	 * @param paramMap
	 * @return
	 */
	public int queryProductControlAchievingCount(Map<String, Object> paramMap);
	/**
	 * 达成率明细列表
	 * @param paramMap
	 * @return
	 */
	public List<Map<String, Object>> queryProductControlAchievingList(Map<String, Object> paramMap);
	/**
	 * 控货门店总数
	 * @param paramMap
	 * @return
	 */
	public int queryProductControlStoreCount(Map<String, Object> paramMap);
	/**
	 * 控货门店列表
	 * @param paramMap
	 * @return
	 */
	public List<Map<String, Object>> queryProductControlStoreList(Map<String, Object> paramMap);
	/**
	 * 查询开始控货时间
	 * @param paramMap
	 * @return
	 */
	public Map<String, Object> queryproductControlApprovalDate(Map<String, Object> paramMap);
