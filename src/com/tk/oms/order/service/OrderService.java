...
public class OrderService {
	...
	public ProcessResult orderCancel(HttpServletRequest request) throws Exception {
		...
		try {
			...
			if(ResponseSateEnum.SUCCESS.getValue().equals(output_status)){//成功
				// 订单关闭，标识异常订单为已处理
				execOrderService.updateExecOrderHandleStateByClose(paramMap.get("order_number").toString());
				/**
				 * 订单取消，返还会员卡额度
				 */
				pr.setState(true);
    ...
    public GridResult distributorOrderList(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            Map<String, Object> resPr = (Map<String, Object>) this.queryForPost(sendMap, retail_service_new_url+"open/Order/orderList");
    ...
    public GridResult distributorOrderDetail(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            Map<String, Object> resPr = (Map<String, Object>) this.queryForPost(sendMap, retail_service_new_url+"open/Order/orderDetail");
            if (Integer.parseInt(resPr.get("state").toString()) == 1) {
                Map<String, Object> data =  (Map<String, Object>)resPr.get("data");
                gr.setState(true);
    ...
    public GridResult distributorOrLogisticsInfo(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            Map<String, Object> resPr = (Map<String, Object>) this.queryForPost(sendMap, retail_service_new_url+"Order/logisticsRecord");
            if (Integer.parseInt(resPr.get("state").toString()) == 1) {
